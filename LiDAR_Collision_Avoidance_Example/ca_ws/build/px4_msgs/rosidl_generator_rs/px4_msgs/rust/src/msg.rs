...
impl Default for CommandValues {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::CommandValues::default())
  }
}

impl rosidl_runtime_rs::Message for CommandValues {
  type RmwMsg = super::msg::rmw::CommandValues;

  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        timestamp: msg.timestamp,
        rc_on_off_log: msg.rc_on_off_log,
        d_mode_log: msg.d_mode_log,
        wp_mode_log: msg.wp_mode_log,
        u_cmd_log: msg.u_cmd_log,
        x_cmd_log: msg.x_cmd_log,
        y_cmd_log: msg.y_cmd_log,
        psi_cmd_log: msg.psi_cmd_log,
        ye_log: msg.ye_log,
        x_berth_start: msg.x_berth_start,
        y_berth_start: msg.y_berth_start,
        x_berth_end: msg.x_berth_end,
        y_berth_end: msg.y_berth_end,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      timestamp: msg.timestamp,
      rc_on_off_log: msg.rc_on_off_log,
...
impl Default for InputTau {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::InputTau::default())
  }
}

impl rosidl_runtime_rs::Message for InputTau {
  type RmwMsg = super::msg::rmw::InputTau;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        timestamp_last_signal: msg.timestamp_last_signal,
        channel_count: msg.channel_count,
        docking_type: msg.docking_type,
        wp_guid: msg.wp_guid,
        docking_guid: msg.docking_guid,
        dock_x: msg.dock_x,
        dock_y: msg.dock_y,
...
impl Default for ModeFlag {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::ModeFlag::default())
  }
}

impl rosidl_runtime_rs::Message for ModeFlag {
  type RmwMsg = super::msg::rmw::ModeFlag;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        modeone: msg.modeone,
        modetwo: msg.modetwo,
        modethree: msg.modethree,
        modefour: msg.modefour,
        modefive: msg.modefive,
        modesix: msg.modesix,
        modeseven: msg.modeseven,
        modeeight: msg.modeeight,
        modenine: msg.modenine,
        modeten: msg.modeten,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      timestamp: msg.timestamp,
...
impl Default for OutputTest {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::OutputTest::default())
  }
}

impl rosidl_runtime_rs::Message for OutputTest {
  type RmwMsg = super::msg::rmw::OutputTest;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        sates: msg.sates,
        command: msg.command,
        estimated_d: msg.estimated_d,
        eso_type: msg.eso_type,
        nomoto_t: msg.nomoto_t,
        nomoto_k: msg.nomoto_k,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      timestamp: msg.timestamp,
      timestamp_last_signal: msg.timestamp_last_signal,
...
impl Default for SimulinkCustomMessage {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::SimulinkCustomMessage::default())
  }
}

impl rosidl_runtime_rs::Message for SimulinkCustomMessage {
  type RmwMsg = super::msg::rmw::SimulinkCustomMessage;

  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        timestamp: msg.timestamp,
        single_a: msg.single_a,
        single_b: msg.single_b,
        double_a: msg.double_a,
        double_b: msg.double_b,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      timestamp: msg.timestamp,
      single_a: msg.single_a,
...
impl Default for StatesAndActuators {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::StatesAndActuators::default())
  }
}

impl rosidl_runtime_rs::Message for StatesAndActuators {
  type RmwMsg = super::msg::rmw::StatesAndActuators;

  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        timestamp: msg.timestamp,
        u_time_log: msg.u_time_log,
        v_time_log: msg.v_time_log,
        r_time_log: msg.r_time_log,
        x_time_log: msg.x_time_log,
        y_time_log: msg.y_time_log,
        psi_time_log: msg.psi_time_log,
        taux_time_log: msg.taux_time_log,
        tauy_time_log: msg.tauy_time_log,
        taun_time_log: msg.taun_time_log,
        motor1_time_log: msg.motor1_time_log,
        motor2_time_log: msg.motor2_time_log,
        motor3_time_log: msg.motor3_time_log,
        motor4_time_log: msg.motor4_time_log,
        alpha1_time_log: msg.alpha1_time_log,
        alpha2_time_log: msg.alpha2_time_log,
        alpha3_time_log: msg.alpha3_time_log,
        alpha4_time_log: msg.alpha4_time_log,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      timestamp: msg.timestamp,
      u_time_log: msg.u_time_log,

...
#include "px4_msgs/msg/detail/actuator_command__rosidl_typesupport_fastrtps_c.h"
...
using _ActuatorCommand__ros_msg_type = px4_msgs__msg__ActuatorCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: motor_pwm
  {
    cdr << ros_message->motor_pwm;
  }
...
size_t get_serialized_size_px4_msgs__msg__ActuatorCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name motor_pwm
  {
    size_t item_size = sizeof(ros_message->motor_pwm);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name steering_pwm
...
static uint32_t _ActuatorCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__ActuatorCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_px4_msgs__msg__ActuatorCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs__msg__ActuatorCommand;
    is_plain =
      (
...
static size_t _ActuatorCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4_msgs__msg__ActuatorCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, ActuatorCommand)() {

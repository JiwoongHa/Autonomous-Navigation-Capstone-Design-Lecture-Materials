...
#include "px4_msgs/msg/detail/actuator_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::ActuatorCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::ActuatorCommand & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::ActuatorCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::ActuatorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::ActuatorCommand *>(
    untyped_ros_message);
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_ActuatorCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, ActuatorCommand)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_ActuatorCommand__handle;
}
